...
public class BrandManager implements BrandService {
	...
	public List<GetAllBrandsResponse> getAll() {
		List<Brand> brands = brandRepesitory.findAll();//brandrepesitori hepsini ara
														//stream.map elimizde bir liste varsa onu tektek dolasmanızı sağlıyor foreachın yaptıgını yapıyor.
	...
	Brand brand =this.modelMapperService.forRequest().map(createBrandRequest,Brand.class);//createbrandrequesti brand tipine çevir
											//arka planda brand newlıyor sonra createbrandreuestın tum alanlarını karsılastırıp aynı olanları new ledıgıne aktarıyor
	...
	public void delete(int id) {
		...
		//deletebyid id sine bakarak deşete işlemi yapar
		//silme işlemini farklı parametrelerle yapılacaksa request nesnesine cevirebiliriz
